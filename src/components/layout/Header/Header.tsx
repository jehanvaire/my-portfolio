      ...
      <div className="header-content">
        ...
        <div ref={menuRef}>
          <nav className={`nav ${isMenuOpen ? "open" : ""}`}>
            ...
            <Link
              to="/projects"
              className={`bn5 ${isActive("/projects") ? "active" : ""}`}
            ...
            <Link
              to="/skills"
              className={`bn5 ${isActive("/skills") ? "active" : ""}`}
            ...
            <Link
              to="/contact"
              className={`bn5 ${isActive("/contact") ? "active" : ""}`}
