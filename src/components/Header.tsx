    ...
    <header className={`header ${theme}`}>
      <div className="header-content">
        ...
        <nav className={`nav ${isMenuOpen ? "open" : ""}`}>
          <Link to="/" className={`bn5 ${isActive('/') ? 'active' : ''}`}>
            Home
          </Link>
          <Link to="/about" className={`bn5 ${isActive('/about') ? 'active' : ''}`}>
            About
          </Link>
          <Link to="/projects" className={`bn5 ${isActive('/projects') ? 'active' : ''}`}>
            Projects
          </Link>
          <Link to="/skills" className={`bn5 ${isActive('/skills') ? 'active' : ''}`}>
            Skills
          </Link>
          <Link to="/contact" className={`bn5 ${isActive('/contact') ? 'active' : ''}`}>
            Contact
          </Link>
        </nav>
