    ...
    <header className={`header ${theme}`}>
      <div className="header-content">
        ...
        <nav className={`nav ${isMenuOpen ? 'open' : ''}`}>
          <Link to="/" className="bn5">Home</Link>
          <Link to="/about" className="bn5">About</Link>
          <Link to="/projects" className="bn5">Projects</Link>
          <Link to="/skills" className="bn5">Skills</Link>
          <Link to="/contact" className="bn5">Contact</Link>
        </nav>
